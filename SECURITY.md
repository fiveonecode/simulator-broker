...
tagged Alpha (`0.1.0-alpha.6`). Older Alpha tags are not supported. The
published Alpha has exactly four custom GitHub Release assets:

1. `simulator-broker-0.1.0-alpha.6-cli.tar.gz`
2. `simulator-broker-0.1.0-alpha.6-cli.tar.gz.sha256`
3. `simbroker-0.1.0-alpha.6.tgz`
4. `Simulator-Broker-0.1.0-alpha.6.zip`
