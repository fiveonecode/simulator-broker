...
1. Identify the paths you intend to change and choose a task session dir under `$AGENT_HOME/agent-harness/simulator-broker-app/` (defaults to `~/.agents/agent-harness/simulator-broker-app/`; `CODEX_HOME` remains a compatibility parent).
