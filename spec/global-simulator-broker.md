...
| --- | --- | --- |
| 0.16.7 | 2026-08-31 | App restart-required status requires canonical exit code `3`, operator refresh captures lifecycle ownership when queued, and missing-host probe failures clear stale live-service authority while remaining onboarding. |
