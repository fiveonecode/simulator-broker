...
- `app/` — XcodeGen spec, SwiftUI source, and XCTest coverage for the macOS operator app; supported generation atomically emits an ignored `Sources/Generated/BrokerRuntimeVersion.generated.swift` constant from the root package version before XcodeGen runs
