...
- `Formula/` — Homebrew CLI formula for the tagged Alpha tarball
...
- `scripts/` — repo-owned helper scripts including the canonical
  ...
  (`package_cli.sh`), npm CLI packing (`package_npm.sh`), distribution install, portable package creation, smoke
