...
- app project generation atomically derives an ignored Swift runtime-version constant from the root `package.json`; it is separate from bundle marketing/build metadata and is regenerated before every supported build or test entrypoint
